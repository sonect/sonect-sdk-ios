...
install_xcframework "${PODS_ROOT}/sonect-google-address-autocompletion-plugin/GoogleAddressAutocompletionPlugin.xcframework" "GoogleAddressAutocompletionPlugin" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
